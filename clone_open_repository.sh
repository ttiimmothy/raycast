...
# @raycast.title Clone repository for open
...
# Documentation:
# @raycast.description print all openrice canada organization repositories to local
...
for repo in ${REPOS}; do
  ...
  repo_local_path=$OPENRICE_CANADA_ORGANIZATION_PATH/${repo_name_with_underscore}
